...
// 2019-07-07
// @descripcion: clase emisor bluetooth de la placa
// ----------------------------------------------------------
...
public:
  ...
  // .........................................................
  // .........................................................
  using CallbackConexionEstablecida = void ( uint16_t connHandle ); // using sirve para darle un nombre igual que typedef
  using CallbackConexionTerminada = void ( uint16_t connHandle, uint8_t reason);

  // .........................................................
  // .........................................................
  /**      
   *        EmisoraBLE()   constructor de la clase   
   *        @nombreEmisora:[char] array de caracteres con el nombre
   *        @fabricanteID_:N id del fabricante
   *        @txPower_:N valor al que se engancha el transmisor           
   */
  ...
  */
  ...
  // .........................................................
    /**      
    *        encenderEmisora()  llama a la placa y la inicializa, detiene anuncio
    **/
  ...
  // .........................................................
    /**      
     *        encenderEmisora()  
     *        @cbce:CallbackConexionEstablecida cb para empezar la conexion
     *        @cbct:CallbackConexionTerminada cb para terminar la conexion
     */
  ...
  // .........................................................
      /**      
       *        detenerAnuncio() comprueba estaAnunciado y si es true detiene el anuncio
       */
  void detenerAnuncio() {
  ...
  // .........................................................
  /**      
   *        estaAnunciado() comprueba si hay un anuncio en la bluefruit            
   *        @return VoF si hay un anuncio en proceso      */
  bool estaAnunciando() {
  ...
  // .........................................................
    /**      
     *        emitirAnuncioBeacon()   proceso de enviar un beacon    
     *        @beaconUUID:[N] array de enteros con el id maximo 16
     *        @major:N entero para identificar grupos de beacon
     *        @minor:N entero para identificar beacons dentro de un grupo
     *        @rssi:N entero indicador de intensidad de señal recibida
     */
  ...
  // ......................................................... 
    /**      
     *        emitirAnuncioBeacon() enviar beacon sin los datos de la funcion anterior 
     *        @carga:[char] array de caracteres con la informacion del beacon
     *        @tamanyoCarga:N entero del tamaño de la carga
     */
  ...
  // .........................................................
     /**      
     *        anyadirServicios()   añade un servicio a la emisora
     *        @servicio:ServicioEnEmisora servicio que añadimos
     *        
     *        @return VoF si se añade correctamente*/
  ...
  // .........................................................
     /**      
     *        anyadirServicioConSusCaracteristicas()   añade un servicio a la emisora con sus caracteristicas
     *        @servicio:ServicioEnEmisora servicio que añadimos
     *        
     *        @return VoF si se añade correctamente*/
  ...
  template <typename ... T>
     /**      
     *        anyadirServicioConSusCaracteristicasYActivar()   añade un servicio a la emisora con sus caracteristicas y lo activa
     *        @servicio:ServicioEnEmisora servicio que añadimos
     *        
     *        @return VoF si se añade correctamente*/
  ...
  // .........................................................
     /**      
     *       instalarCallbackConexionEstablecida() cb para comprobar si se establece conexion
     *       @cb:CallbackConexionEstablecida callback
     */
  ...
  // .........................................................
     /**      
     *       instalarCallbackConexionTerminada() cb para comprobar si se termina la conexion
     *       @cb:CallbackConexionTerminada callback
     */
  ...
  // .........................................................
     /**      
     *       getConexion() obtiene la conexion BLE segun el N que entra
     *       @connHandle:N numero de la conexion
     *       
